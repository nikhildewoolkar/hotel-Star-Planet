<%@ Page Title="" Language="C#" MasterPageFile="adminMasterPage.master" AutoEventWireup="true" CodeFile="viewUpdateDeletemenuitem.aspx.cs" Inherits="admin_viewproduct" Debug="true" %>
...
<br/>
<center><h2> Add / Update  /Delete Menuitems </h2></center>
<br/><br />
    <asp:GridView ID="GridView1" runat="server" 
        ...
        <asp:TemplateField HeaderText="menuitemid" HeaderStyle-Width="150px">
                <EditItemTemplate>
                    <asp:TextBox ID="txtprodid" runat="server" Text='<%# Eval("menuitemid") %>'/>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="lblprodid" runat="server" Text='<%# Eval("menuitemid") %>' ></asp:Label>
                </ItemTemplate>
