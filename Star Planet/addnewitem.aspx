<%@ Page Title="" Language="C#" MasterPageFile="adminMasterPage.master" AutoEventWireup="true" CodeFile="addnewitem.aspx.cs" Inherits="addnewitem" %>
...
<p class="text" style="color:maroon"> Upload Photo : &nbsp;&nbsp;&nbsp;&nbsp;<asp:FileUpload ID="menuitemimage" runat="server" />   </p>  
       
      								

		
        <center>
		<div class="agile-submit">   <asp:Button ID="btnAddMenuItem" runat="server" Text="Add MenuItem" onclick="btnAddMenuItem_Click" />     </div>
        </center>
    									</div>                                    
							</div>
	                       </td></tr></table>
