...
public partial class addnewitem : System.Web.UI.Page
{
    ...
    protected void btnAddMenuItem_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            String folderpath = "~/images/menuitems/";
            ...
            cmd.CommandText = @"insert into menuitems(menuitemname,description,imageurl,price) values (@menuitemname,@description,@imageurl,@price)";
            cmd.Connection = con;
