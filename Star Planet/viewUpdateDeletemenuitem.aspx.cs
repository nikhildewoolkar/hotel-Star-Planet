...

{
    ...
    protected void ImageData()
    {
        ...
        con.Open();
        da = new SqlDataAdapter("select * from menuitems", con);
        ds = new DataSet();
        da.Fill(ds);
    ...
    protected void gvImage_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("update menuitems set menuitemname='" + name.Text + "',imageurl='" + path + "',description='" + desc.Text.Trim() + "',price='" + price.Text + "' where menuitemid= " + prodId + "", con);
    ...
    protected void gvImage_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        con = new SqlConnection(connStr);
        con.Open();
        SqlCommand cmd = new SqlCommand("delete FROM menuitems where menuitemid='" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value.ToString()) + "'", con);
        cmd.ExecuteNonQuery();
        con.Close();
